...
homeAddPetButton.addEventListener('clic', function (event) {
...
homeDeleteCancelButton.addEventListener('clic', function (event) {
    event.preventDefault()
